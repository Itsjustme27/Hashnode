---
title: "Success Writeup"
seoTitle: "Reverse Engineering Haskell"
seoDescription: "Analyze and solve a Haskell code challenge using Z3 constraints for a unique flag. Learn compilation and execution methods"
datePublished: Sat Nov 01 2025 14:30:52 GMT+0000 (Coordinated Universal Time)
cuid: cmhgdqrz5000002l1994u5d9y
slug: success-writeup
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1762007117440/694683b5-6de3-4b87-9184-7d65c7cfa870.png
tags: haskell, reverse-engineering, ctf, ctf-writeup, smileyctf

---

### Provided Source file (Initially success.hs was only given):

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1762007245533/2601db43-0337-45d4-aec4-8cb0d6db6ed4.png align="left")
...
The script is a **Z3 constraint solver script** that finds a flag (a 39-character ASCII string) by solving a set of mathematical and bitwise constraints. Here's a breakdown of *why* the flag `'.;,;.{imagine_if_i_made_it_compiled!!!}'` worked:
